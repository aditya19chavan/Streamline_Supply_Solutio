...
function Register() {
  ...
  const [username, setUsername] = useState(""); // Reflects username in the database
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8085/api/v1/user/save", // Backend API endpoint
        {
          username: username, // Send username field, matches backend entity name
